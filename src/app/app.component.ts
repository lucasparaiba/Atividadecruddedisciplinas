...
export class AppComponent {
  ...
  disciplinas = [
        new Disciplina(1,'Língua Portuguesa', 'O objetivo norteador da BNCC de Língua Portuguesa ' +
            ...
            'vista, partilha ou constrói visões de mundo e produz conhecimento.',new Professor("Patricia")),
        new Disciplina(2,'Educação Física', 'A Educação Física é o componente curricular ' +
            ...
            'Logo, as práticas corporais são textos culturais passíveis de leitura e produção.',new Professor("Jackson")),
        new Disciplina(3,'Inglês', 'Aprender a língua inglesa propicia a criação de novas ' +
            ...
            'qual as dimensões pedagógicas e políticas são intrinsecamente ligadas.',new Professor("Fernando")),
        new Disciplina(4,'Matemática', 'No Ensino Fundamental, essa área, por meio da ' +
            ...
            'podem ser estimuladas, sobretudo ao final do Ensino Fundamental.',new Professor("Cristina")),
        new Disciplina(5,'Ciências', 'Ao estudar Ciências, as pessoas aprendem a respeito ' +
            ...
            'expliquem e intervenham no mundo em que vivem.',new Professor("Fabiano"))
    ];
  ...
  salvar() {
    if (this.editando) {
      ...
      const d = new Disciplina(this.codigo, this.nome, this.descricao, new Professor(this.professor));
